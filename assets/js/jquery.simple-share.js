(function($) {
  $.fn.simpleShare = function(args) {
    var svcData = {
      ...
      settings = $.extend({
        'icons': true,
        // use icons vs. don't use icons
        'color': false,
        // style icons with services' official colors
        'shape': 'smart',
    ...
    if ($.browser.msie && parseFloat($.browser.version) < 8) {
      window.onload = function() {
        function a(a, b) {
          var c = a.innerHTML;
          a.innerHTML = "<span style=\"font-family: 'simple-social-icons'\">" + b + "</span>" + c
        }
        var b = {
            "icon-facebook": "&#x21;",
            "icon-facebook-2": "&#x22;",
